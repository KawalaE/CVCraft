...
export default function Resume({props, education, skills, work, noJob, removeSkills, skillsCollection, noSkills, educationCollection, emptyEducation, removeEduSegment}){
    return (
